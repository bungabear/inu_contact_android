...
//                Toast.makeText(mContext, holder.main_item_tv.getText(), Toast.LENGTH_SHORT).show();
                ...
                ArrayList<Contract> contracts = MainActivity.dbHelper.getContract(holder.main_item_tv.getText().toString());
                ContractAdapter contractAdapter = new ContractAdapter(mContext, contracts);
                MainActivity.actionbar_tv_title.setText(parts.get(position));
